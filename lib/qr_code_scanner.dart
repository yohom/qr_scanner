...
class QRViewController {
  QRViewController._(int id)
      : channel = MethodChannel('net.touchcapture.qr.flutterqr/qrview_$id'),
        qrcodeEventChannel =
            EventChannel('net.touchcapture.qr.flutterqr/qrcode_event');
  final MethodChannel channel;
  final EventChannel qrcodeEventChannel;
  ...
  void stopDecoding() {
    channel.invokeMethod("stopDecoding");
  }
}
